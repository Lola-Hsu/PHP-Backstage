...
<div class="container-fluid">
    <div class="row">
        ...
        if(isset($_GET['itemId'])) {
            //SQL 敘述
            $sql = "SELECT `items`.`itemId`, `items`.`itemName`, `items`.`imgURL`, `items`.`itemPrice`, 
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="row mb-3 d-flex justify-content-center">
                        <img class="item-view border" src="<?php echo $arr[0]["imgURL"]; ?>">
                    </div>
                    <div class="row">
                        <img class="item-preview img-thumbnail border" src="<?php echo $arr[0]["imgURL"]; ?>" alt="...">
                    <?php 
                    //找出預覽圖片
