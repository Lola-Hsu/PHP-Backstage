                ...
                WHERE `couponID` = ? ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="border p-3">
                                    <input class="form-control" type="text" name="couponMoney" value="<?php echo $arr[0]['couponMoney']; ?>" maxlength="11" />
                                </td>
                                <td class="border p-3">
                                    <input class="form-control" type="text" name="Remarks" value="<?php echo $arr[0]['Remarks']; ?>" maxlength="3" />
                                </td>
                    ...
                    <tfoot>
                        <tr>
                            <td class="border" colspan="7"><button class="smbtn btn btn-outline-light float-left m-2" type="submit" name="smb">更新</button></td>
                        </tr>
